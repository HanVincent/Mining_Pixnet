...
namespace CrewPages
{
    class Program
    {
        ...
        {
            //string url = @"https://emma.pixnet.cc/mainpage/blog/categories/hot_weekly/24?page=1&per_page=100&api_version=2&format=json";//pixnet API，近期熱門文章，24: 數位生活
            ...
            while (true)
            {
                string j_content = crewWeb(@"https://emma.pixnet.cc/mainpage/blog/categories/hot_weekly/24?page="+page+ "&per_page=100&api_version=2&format=json");//近期熱門文章，未parse
                ...
                StreamWriter sw = new StreamWriter(@"./hot_weekly/hot_weekly_" + page + ".json");//將最近熱門的寫成檔案
        ...
        public static string crewWeb(string url)
        {
            ...
            WebResponse myResponse = myRequest.GetResponse();//取得回應
        ...
        public static void getArticleLinkAndArticle(string jsonContent, bool LinkOrArticle)
        {
